      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card className="lg:col-span-2 bg-card-sky-blue/20 border-card-sky-blue/30">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Button onClick={() => router.push('/planner')} variant="ghost" size="sm" className="text-card-sky-blue hover:bg-card-sky-blue/20 hover:text-card-sky-blue">
        ...
        <Card className="bg-card-deep-red/20 border-card-deep-red/30 relative">
          ...
          <CardContent className="flex flex-col items-center text-center">
             ...
             <Button onClick={() => router.push('/resume')} variant="outline" className="bg-transparent border-card-deep-red/50 text-card-deep-red hover:bg-card-deep-red/10 hover:text-card-deep-red">
                Optimize Resume
             </Button>
          </CardContent>
        </Card>
        ...
        <Card className="bg-card-purple-gradient/20 border-card-purple-gradient/30 relative">
          ...
          <CardContent className="flex flex-col items-center text-center">
             ...
             <Button onClick={() => router.push('/study')} variant="outline" className="bg-transparent border-card-purple-gradient/50 text-card-purple-gradient hover:bg-card-purple-gradient/10 hover:text-card-purple-gradient">
                Get Study Plan
             </Button>
          </CardContent>
        </Card>

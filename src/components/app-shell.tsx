...
import { LayoutDashboard, CalendarCheck, Target, FileText, BookOpen, HeartPulse, Languages, ShieldCheck, Moon, Sparkles, Salad, BrainCircuit } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/voice-coach', label: 'Voice Coach', icon: BrainCircuit },
